...
const kbdVariants = cva(
  "inline-flex items-center justify-center rounded-md px-2 py-1.5 text-sm font-medium transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-background",
  {
    variants: {
      variant: {
        default:
          //   "bg-dark-section border-dark-section--lighters text-muted border shadow-sm hover:bg-dark-section--lighter",
          "bg-dark-bg--lighter hover:bg-dark-section border border-border text-white",
        accent:
          //   "bg-blue-600 text-white border border-blue-500 shadow-sm hover:bg-blue-500",
          "bg-dark-bg--lighter hover:bg-brand border border-border text-white",
        ghost:
          //   "bg-transparent text-gray-300 border border-gray-700 hover:bg-gray-800",
          "bg-dark-bg--lighter hover:bg-dark-section border border-transparent hover:border-border text-white",
      },
      size: {
        default: "h-8",
