...
export function useColorPicker(folders: Folder[], activeFolder: string, setFolders: React.Dispatch<React.SetStateAction<Folder[]>>) {
    ...
    const handleColorPick = useCallback((event: React.MouseEvent<HTMLImageElement>) => {
